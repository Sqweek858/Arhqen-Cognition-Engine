...
Assert-Contains "perf2r3_drag_autoscroll_lmb_lifetime" $ShellText "Autoscroll must never outlive drag"
Assert-Contains "perf2r3_scrollbar_drag_released" $ShellText "aquariumDraggingScroll_ == &engineLogOverlayScroll_"
Assert-Contains "perf2r3_double_click_word" $ShellText "Double click selects one word"
Assert-Contains "perf2r3_triple_click_row" $ShellText "Triple click selects the complete visual log row"
Assert-Contains "perf2r3_lazy_line_layout_cache" $ShellText "engineLogTextLayoutForLine"
